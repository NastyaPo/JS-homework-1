...
var myPi = Math.PI;
console.log('константа Pi', myPi); // константа Pi → myPi

var myRound = Math.round(89.279);
console.log('округленное значение числа 89.279', myRound); // округленное значение числа 89.279 → myRound

var myRandom = Math.random()*10;
console.log('случайное число между 0..10', myRandom); // случайное число между 0..10 → myRandom

var myPow = Math.pow(3,5);
console.log('3 в 5 степени', myPow); // 3 в 5 степени → myPow
...
var myString = 'Lorem Ipsum Dolor Sit Amet, Consectetur Adipisicing.';
